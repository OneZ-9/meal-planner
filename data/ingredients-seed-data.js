...
module.exports = [
  ...
  { name: "Brown rice flour", unitFamily: "weight", densityGPerMl: 0.550 },
  { name: "Granulated sugar", unitFamily: "weight", densityGPerMl: 0.845 },
  { name: "Brown sugar", unitFamily: "weight", densityGPerMl: 0.900 },
  { name: "Powdered sugar", unitFamily: "weight", densityGPerMl: 0.507 },
  { name: "Cornstarch", unitFamily: "weight", densityGPerMl: 0.507 },
  { name: "Baking powder", unitFamily: "weight", densityGPerMl: 0.930 },
  { name: "Baking soda", unitFamily: "weight", densityGPerMl: 0.930 },
  { name: "Table salt", unitFamily: "weight", densityGPerMl: 1.234 },
  { name: "Kosher salt", unitFamily: "weight", densityGPerMl: 0.550 },
  ...
  { name: "Rolled oats", unitFamily: "weight", densityGPerMl: 0.380 },
  ...
  { name: "Almond butter", unitFamily: "weight", densityGPerMl: 1.070 },
  { name: "Parmesan cheese, grated", unitFamily: "weight", densityGPerMl: 0.423 },
  { name: "Cheddar cheese, shredded", unitFamily: "weight", densityGPerMl: 0.478 },
  { name: "Mozzarella cheese, shredded", unitFamily: "weight", densityGPerMl: 0.423 },

  // ---- Spices & dried herbs (weight family) ----
  { name: "Ground cinnamon", unitFamily: "weight", densityGPerMl: 0.440 },
  ...
  { name: "Dried oregano", unitFamily: "weight", densityGPerMl: 0.190 },
  { name: "Dried basil", unitFamily: "weight", densityGPerMl: 0.169 },
  { name: "Ground turmeric", unitFamily: "weight", densityGPerMl: 0.423 },
  { name: "Curry powder", unitFamily: "weight", densityGPerMl: 0.380 },
  { name: "Nutritional yeast", unitFamily: "weight", densityGPerMl: 0.270 },
  ...
  { name: "Whole milk", unitFamily: "volume", densityGPerMl: 1.030 },
  { name: "2% milk", unitFamily: "volume", densityGPerMl: 1.020 },
  { name: "Skim milk", unitFamily: "volume", densityGPerMl: 1.010 },
  { name: "Almond milk, unsweetened", unitFamily: "volume", densityGPerMl: 1.000 },
  { name: "Soy milk", unitFamily: "volume", densityGPerMl: 1.000 },
  { name: "Oat milk", unitFamily: "volume", densityGPerMl: 1.000 },
  { name: "Coconut milk, canned", unitFamily: "volume", densityGPerMl: 1.020 },
  { name: "Heavy cream", unitFamily: "volume", densityGPerMl: 1.010 },
  { name: "Half and half", unitFamily: "volume", densityGPerMl: 1.020 },
  { name: "Sour cream", unitFamily: "volume", densityGPerMl: 1.020 },
  { name: "Plain yogurt", unitFamily: "volume", densityGPerMl: 1.030 },

  // ---- Condiments, sauces & vinegars (volume family) ----
  { name: "Soy sauce", unitFamily: "volume", densityGPerMl: 1.080 },
  { name: "White vinegar", unitFamily: "volume", densityGPerMl: 1.010 },
  { name: "Apple cider vinegar", unitFamily: "volume", densityGPerMl: 1.010 },
  { name: "Balsamic vinegar", unitFamily: "volume", densityGPerMl: 1.080 },
  { name: "Rice vinegar", unitFamily: "volume", densityGPerMl: 1.010 },
  { name: "Lemon juice", unitFamily: "volume", densityGPerMl: 1.050 },
  { name: "Lime juice", unitFamily: "volume", densityGPerMl: 1.040 },
  { name: "Orange juice", unitFamily: "volume", densityGPerMl: 1.050 },
  { name: "Worcestershire sauce", unitFamily: "volume", densityGPerMl: 1.100 },
  { name: "Fish sauce", unitFamily: "volume", densityGPerMl: 1.080 },
  { name: "Hoisin sauce", unitFamily: "volume", densityGPerMl: 1.150 },
  { name: "Oyster sauce", unitFamily: "volume", densityGPerMl: 1.150 },
  { name: "Ketchup", unitFamily: "volume", densityGPerMl: 1.120 },
  { name: "Mayonnaise", unitFamily: "volume", densityGPerMl: 0.930 },
  { name: "Yellow mustard", unitFamily: "volume", densityGPerMl: 1.050 },
  { name: "Dijon mustard", unitFamily: "volume", densityGPerMl: 1.050 },
  { name: "Hot sauce", unitFamily: "volume", densityGPerMl: 1.040 },
  { name: "BBQ sauce", unitFamily: "volume", densityGPerMl: 1.150 },
  { name: "Honey", unitFamily: "volume", densityGPerMl: 1.437 },
  { name: "Maple syrup", unitFamily: "volume", densityGPerMl: 1.361 },
  { name: "Molasses", unitFamily: "volume", densityGPerMl: 1.400 },
  { name: "Vanilla extract", unitFamily: "volume", densityGPerMl: 0.880 },

  // ---- Stocks & water (volume family) ----
  { name: "Water", unitFamily: "volume", densityGPerMl: 1.000 },
  { name: "Chicken stock", unitFamily: "volume", densityGPerMl: 1.010 },
  { name: "Vegetable stock", unitFamily: "volume", densityGPerMl: 1.010 },
  { name: "Beef stock", unitFamily: "volume", densityGPerMl: 1.010 },
  { name: "White wine (cooking)", unitFamily: "volume", densityGPerMl: 0.990 },
  { name: "Red wine (cooking)", unitFamily: "volume", densityGPerMl: 0.990 },
